  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-heading-3 text-dark-900 mb-2">Join Nike</h1>
        <p className="text-body text-dark-700">
          Create your Nike account to get started
        </p>
      </div>
      ...
      {/* Terms and Privacy */}
      <div className="text-center">
        <p className="text-caption text-dark-700 leading-relaxed">
          By creating an account, you agree to Nike&apos;s{" "}
          <Link
            href="/terms"
            className="text-dark-900 hover:underline transition-colors"
          >
            Terms of Use
          </Link>{" "}
          and{" "}
