...
ALTER TABLE "carts" ADD CONSTRAINT "carts_guest_id_guest_sessionToken_fk" FOREIGN KEY ("guest_id") REFERENCES "public"."guest"("sessionToken") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
